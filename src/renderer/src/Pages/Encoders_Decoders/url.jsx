...
const UrlEncoderDecoder = () => {
  ...
  return (
    <div className="w-[100%] flex flex-wrap justify-between gap-8 lg:gap-0">
      <PageHeading>URL Encoder/Decoder</PageHeading>
      <Card tailStyle={'w-[100%] lg:w-[50%]'}>
        ...
        <form className="p-4 px-6 ">
          <div className="relative inline-flex flex-col w-[100%] mb-4">
            ...
            />
            <FontAwesomeIcon icon={faCopy} className="absolute top-11 right-4 cursor-pointer text-gray-300" onClick={() => handleCopy(encodedText)} />
          </div>
        </form>
      </Card>
      <Card tailStyle={'w-[100%] lg:w-[50%]'}>
        ...
        <form className="p-4 px-6 ">
          <div className="relative inline-flex flex-col w-[100%] mb-4">
            ...
            />
            <FontAwesomeIcon icon={faCopy} className="absolute top-11 right-4 cursor-pointer text-gray-300" onClick={() => handleCopy(decodedText)} />
          </div>
        </form>
      </Card>
      {showPrompt && (
